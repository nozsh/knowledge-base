...
description: "База интересной, полезной и не очень информации."
# aliases:
#   - callouts
sidebar:
  # open: true
...
{{< badge  type="info" content="База знаний" >}}
...
{{< card link="black-flag" title="Черный флаг" icon="game-icons pirate-flag" tagType="" tag="🦜" subtitle="Полезные ресурсы для интернет пирата." >}}
{{< /cards >}}
