...
- {{< icon "trust good" >}} [RuTracker](https://rutracker.org/?nt) <sup>🐐 🌟 (R)</sup>
  - Широкая библиотека жанров. Надежные модераторы.
...
- {{< icon "trust medium" >}} [TorrentLeech](https://www.torrentleech.org/?nt) <sup>(RR)</sup>
  ...
  - Инвайт можно получить если регулярно заходить на сайт и смотреть новости, когда нибудь там будет инвайт.

<br>

- {{< icon "trust low" >}} [LimeTorrents](https://www.limetorrents.lol/?nt)
...
- {{< icon "trust low" >}} [TorrentFunk](https://www.torrentfunk.com/?nt)
